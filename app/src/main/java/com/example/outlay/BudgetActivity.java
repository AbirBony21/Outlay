            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if (snapshot.exists() && snapshot.getChildrenCount()>0){
                    ...
                    for (DataSnapshot snap:snapshot.getChildren()){
                        ...
                        String sttotal=String.valueOf("Month Budget: Tk "+totalammount);
        ...
        FirebaseRecyclerAdapter<Data, myViewHolder> adapter = new FirebaseRecyclerAdapter<Data, myViewHolder>(options) {
            ...
            protected void onBindViewHolder(@NonNull myViewHolder holder,final int position, @NonNull final Data model) {
                ...
                switch(model.getItem()){
                    case "Transport":
                        holder.imageView.setImageResource(R.drawable.ic_transport1);
                        break;
                    case "Food":
                        holder.imageView.setImageResource(R.drawable.ic_food1);
                        break;
                    case "House":
                        holder.imageView.setImageResource(R.drawable.ic_house1);
                        break;
                    case "Entertainment":
                        holder.imageView.setImageResource(R.drawable.ic_entertainment1);
                        break;
                    case "Education":
                        holder.imageView.setImageResource(R.drawable.ic_education1);
                        break;
                    case "Charity":
                        holder.imageView.setImageResource(R.drawable.ic_consultancy1);
                        break;
                    case "Apparel":
                        holder.imageView.setImageResource(R.drawable.ic_shirt1);
                        break;
                    case "Health":
                        holder.imageView.setImageResource(R.drawable.ic_health1);
                        break;
                    case "Personal":
                        holder.imageView.setImageResource(R.drawable.ic_personalcare1);
                        break;
                    case "Other":
                        holder.imageView.setImageResource(R.drawable.ic_other1);
                        break;
                }
